...
//
    /**
     * @Route("/admin/soortactiviteitbeheer", name="soortactiviteitbeheer")
     */
    public function soortactiviteitbeheerAction()
    {
        $soortactiviteit=$this->getDoctrine()
            ->getRepository('App:soortactiviteit')
            ->findAll();

        return $this->render('medewerker/soortactiviteitbeheer.html.twig', [
            'soortactiviteit'=>$soortactiviteit
        ]);
    }

    /**
     * @Route("/admin/soortactiviteitadd", name="add")
     */
    public function soortactiviteitaddAction(Request $request)
    {
        // create a user and a contact
        $a=new Soortactiviteit();

        $form = $this->createForm(soortactiviteit::class, $a);
        $form->add('save', SubmitType::class, array('label'=>"voeg toe"));
        //$form->add('reset', ResetType::class, array('label'=>"reset"));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('soortactiviteitbeheer');
        }
        $activiteiten=$this->getDoctrine()
            ->getRepository('App:soortactiviteit')
            ->findAll();
        return $this->render('medewerker/soortactiviteitadd.html.twig',array('form'=>$form->createView(),'naam'=>'toevoegen','aantal'=>count($activiteiten)
        ));
    }
//
//    /**
